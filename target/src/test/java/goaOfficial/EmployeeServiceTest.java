...
public class EmployeeServiceTest {
	...
	public void shouldGetSingleEmployee(){
		int empCompanyID = 570;
		Mockito.when(employeeRepository.getEmployee(empCompanyID)).thenReturn(new  Employe(1, "TEST", 570, "7276186835", true, "MALE", "SD"));	
		Employe employee = employeeService.getEmployee(empCompanyID);
		int recCompnID = employee.getCompanyEmpID();
		assertEquals(570, recCompnID);
	}
